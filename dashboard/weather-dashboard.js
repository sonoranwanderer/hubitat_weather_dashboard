...
(() => {
  ...
  // src/adapters/hubitat-tiles.js
  var require_hubitat_tiles = __commonJS({
    "src/adapters/hubitat-tiles.js"(exports, module) {
      var DEFAULT_TILE_PREFIX = "tile-";
      function createHubitatTilesAdapter(options = {}) {
        var _a;
        const {
          displayTileId = "tile-0",
          knownPayloadKeys = /* @__PURE__ */ new Set(),
          safeRenderFromData = () => {
          },
        ...
        const hostWindow = providedWindow != null ? providedWindow : typeof window !== "undefined" ? window : void 0;
        const hostDocument = providedDocument != null ? providedDocument : typeof document !== "undefined" ? document : (_a = hostWindow == null ? void 0 : hostWindow.document) != null ? _a : void 0;
        const hostGlobal = providedGlobal != null ? providedGlobal : typeof globalThis !== "undefined" ? globalThis : hostWindow != null ? hostWindow : {};
        const invalidJsonTiles = /* @__PURE__ */ new Set();
        let lastSourceTileIds = [];
        const maskedTileIds = /* @__PURE__ */ new Set();
        const dataTileObservers = /* @__PURE__ */ new Map();
        ...
        function noteInvalidJson(tileId, reason) {
          var _a2;
          if (!tileId || tileId === displayTileId)
            return;
          if (invalidJsonTiles.has(tileId))
            return;
          const suffix = reason ? `: ${reason}` : "";
          if ((_a2 = hostWindow == null ? void 0 : hostWindow.console) == null ? void 0 : _a2.info) {
        ...
        function readPayloads() {
          ...
          for (const tile of tiles) {
            const id = tile == null ? void 0 : tile.id;
            if (!tile || id === displayTileId || !id)
              continue;
        ...
        function toggleSourceTileMask(hide) {
          ...
          if (hide) {
            ...
            for (const id of staleIds) {
              const tile = byId(id);
              if ((_a2 = tile == null ? void 0 : tile.classList) == null ? void 0 : _a2.remove)
                tile.classList.remove("wdash-source-tile");
              maskedTileIds.delete(id);
            }
            for (const id of currentIds) {
              const tile = byId(id);
              if (!((_b = tile == null ? void 0 : tile.classList) == null ? void 0 : _b.add))
                continue;
            ...
            for (const id of Array.from(maskedTileIds)) {
              const tile = byId(id);
              if ((_c = tile == null ? void 0 : tile.classList) == null ? void 0 : _c.remove)
                tile.classList.remove("wdash-source-tile");
            }
            maskedTileIds.clear();
          }
        ...
        function getDisplayTileHostElement() {
          ...
          return content || (root == null ? void 0 : root.parentElement) || root || displayTile || null;
        }
        function debounce(fn, delay) {
          ...
          return (...args) => {
            var _a2, _b;
            if (frame)
              (_a2 = hostGlobal.clearTimeout) == null ? void 0 : _a2.call(hostGlobal, frame);
            frame = (_b = hostGlobal.setTimeout) == null ? void 0 : _b.call(hostGlobal, () => fn(...args), delay);
          };
        }
        function ensureDataTileObservers() {
          ...
          for (const tile of tiles) {
            ...
            const observer = typeof hostGlobal.MutationObserver === "function" ? new hostGlobal.MutationObserver(debounce(safeRenderFromData, 150)) : null;
            if (!observer)
              continue;
        ...
        function watchForTileInsertions() {
          if (domObserver || !hostDocument)
            return;
          const root = hostDocument.body || hostDocument.documentElement;
          if (!root || typeof hostGlobal.MutationObserver !== "function")
            return;
  ...
  var require_render = __commonJS({
    "src/render/index.js"(exports, module) {
      var { createHubitatTilesAdapter } = require_hubitat_tiles();
      function createLegacyWeatherDashboardRenderer(options = {}) {
        var _a, _b, _c, _d;
        const envWindow = (_a = options.window) != null ? _a : typeof window !== "undefined" ? window : void 0;
        const envDocument = (_c = options.document) != null ? _c : typeof document !== "undefined" ? document : (_b = envWindow == null ? void 0 : envWindow.document) != null ? _b : void 0;
        const envGlobal = (_d = options.globalThis) != null ? _d : typeof globalThis !== "undefined" ? globalThis : envWindow != null ? envWindow : {};
        const moduleApi = (() => {
          var _a2;
          const window2 = envWindow;
          const document2 = envDocument;
          const globalThis2 = envGlobal;
          const IS_TEST_ENV = typeof window2 !== "undefined" && (window2 == null ? void 0 : window2.__WDASH_TEST_MODE__) === true;
          if (typeof window2 !== "undefined" && !IS_TEST_ENV) {
            if (window2.__WEATHER_DASHBOARD_SCRIPT_LOADED__ === true) {
              if (window2.console && typeof window2.console.info === "function") {
                window2.console.info("[WeatherDashboard] Script already loaded; skipping duplicate execution.");
              }
              return ((_a2 = window2 == null ? void 0 : window2.weatherDashboard) == null ? void 0 : _a2.__renderer__) || {};
            }
            window2.__WEATHER_DASHBOARD_SCRIPT_LOADED__ = true;
          }
          const DISPLAY_TILE_ID = "tile-0";
          const CSS_ID = "weather-dashboard-css";
          const TEMP_RANGE = { min: -40, max: 120 };
          const DEFAULT_AMBIENT_ROTATION_INTERVAL_MS = 5e3;
          const MIN_AMBIENT_ROTATION_SECONDS = 5;
          const MAX_AMBIENT_ROTATION_SECONDS = 5;
          const DEFAULT_AIR_QUALITY_ROTATION_INTERVAL_MS = 5e3;
          const INIT_RETRY_LIMIT = 40;
          const INIT_RETRY_DELAY = 250;
          const DATA_REFRESH_INTERVAL = 5e3;
          ...
          const KNOWN_PAYLOAD_KEYS = /* @__PURE__ */ new Set([
            "outdoor",
            "indoor",
            "wind",
            "pressure",
  ...
  `;
    ...
    `
          ...
          let ambientRotation = {
            ...
            tempUnit: `\xB0${getDisplayTemperatureUnit()}`,
            humidityUnit: "%",
            countdownTimer: null,
            nextSwitchAt: null,
            paused: false
          ...
          const hubClockFormatterCache = /* @__PURE__ */ new Map();
          const ambientLastHumidity = /* @__PURE__ */ new Map();
          ...
          const CARD_RENDERERS = [
            ...
            { key: "ambient", selector: ".wdash-card--ambient", build: (data, opts) => buildAmbientSensorCard(data, opts == null ? void 0 : opts.ambientSeed) },
          ...
          const tempWindGaugeLastSizes = /* @__PURE__ */ new WeakMap();
          ...
          function isDashboardValueErrorMessage(message) {
            ...
            return text.includes("Cannot set properties of undefined (setting 'value')") || text.includes("value is not defined") || text.includes(`can't access property "value"`);
          }
          function isDashboardValueErrorSource(filename) {
            if (!filename)
              return true;
            const source = String(filename);
            if (source.indexOf("app.js") !== -1)
              return true;
            if (source.indexOf("access_token=") !== -1)
              return true;
            if (/\/tile-\d+/i.test(source))
              return true;
            if (/\btileId=/i.test(source))
              return true;
            return false;
          }
          if (!IS_TEST_ENV) {
          ...
          function whenDomReady(callback) {
            if (document2.readyState === "loading") {
              document2.addEventListener("DOMContentLoaded", callback, { once: true });
            } else {
              callback();
            }
          }
          function patchDashboardGlitches() {
            ...
            const installNoopHistory = () => {
              if (window2.__wdashHistoryInstalling)
                return;
              window2.__wdashHistoryInstalling = true;
              const descriptor = {
                configurable: true,
                get() {
                  return noopHistory;
                ...
                set(value) {
                  if (value === noopHistory)
                    return;
                  setTimeout(() => {
                    window2.__wdashHistorySuppressed = false;
                    installNoopHistory();
                  }, 0);
                }
              };
              try {
                Object.defineProperty(window2, "addToDashboardHistory", descriptor);
              } catch (err) {
                try {
                  window2.addToDashboardHistory = noopHistory;
                } catch (assignErr) {
                }
              }
              window2.__wdashHistoryInstalling = false;
              window2.__wdashHistorySuppressed = true;
              window2.__wdashHistoryPatched = true;
            };
            installNoopHistory();
            if (!window2.__wdashSocketGuard) {
              ...
              window2.__wdashSocketGuard = true;
            }
          }
    ...
    `;
          ...
          function renderFromData() {
            ...
            const grid = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-grid");
            if (!grid)
              return;
            let maskMode = null;
            try {
              applyTemperatureUnitsFromMetadata(payload == null ? void 0 : payload.metadata);
              applyRainUnitsFromMetadata(payload == null ? void 0 : payload.metadata);
              applyWindUnitsFromMetadata(payload == null ? void 0 : payload.metadata);
              applyPressureUnitsFromMetadata(payload == null ? void 0 : payload.metadata);
              applyLightningUnitsFromMetadata(payload == null ? void 0 : payload.metadata);
              applyLayoutOverrides(payload == null ? void 0 : payload.metadata);
              applyScale();
              if (!payload) {
                maskMode = "show";
              ...
              if (!renderState.mounted) {
                ...
                cardsChanged = true;
                try {
                  const ambientContainer2 = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-ambient");
                  if (ambientContainer2)
                    initAmbientLastHum(ambientContainer2);
                } catch (e) {
                }
              } else {
                cardMarkupList.forEach((card) => {
              ...
              const ambientContainer = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-ambient");
          ...
          function collectMeasurementCandidate(element, role) {
            ...
            const rectWidth = Number(rect == null ? void 0 : rect.width);
            const rectHeight = Number(rect == null ? void 0 : rect.height);
          ...
          function measureDisplayTileBaseDimensions() {
            const displayTile = byId(DISPLAY_TILE_ID);
            const content = displayTile ? findContentElement(displayTile) : null;
            const root = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-root");
            const parentHost = (root == null ? void 0 : root.parentElement) || null;
            const seen = /* @__PURE__ */ new Set();
            const candidates = [];
            ...
            return {
              ...
              candidates,
              widthSource: widthSource ? { role: widthSource.role, description: widthSource.description, width: widthSource.width } : null,
              heightSource: heightSource ? { role: heightSource.role, description: heightSource.description, height: heightSource.height } : null
            };
          }
          function resolveMeasuredBaseDimensions(options2 = {}) {
            ...
            let width = Number(measurement == null ? void 0 : measurement.width);
            let height = Number(measurement == null ? void 0 : measurement.height);
            ...
            return {
              ...
              changed,
              raw: measurement,
              widthSource: (measurement == null ? void 0 : measurement.widthSource) || null,
              heightSource: (measurement == null ? void 0 : measurement.heightSource) || null,
              strategy: (measurement == null ? void 0 : measurement.strategy) || null,
              candidates: Array.isArray(measurement == null ? void 0 : measurement.candidates) ? measurement.candidates : null
            };
          }
          ...
          function describeElementForDiagnostics(element) {
            ...
            const classPart = typeof element.className === "string" && element.className.trim() ? "." + element.className.trim().split(/\s+/).join(".") : "";
          ...
          function determineDimensionSource({ sectionValue, fallbackValue, measurementValue }) {
            if (parseDimensionValue(sectionValue) != null)
              return "section-override";
            if (parseDimensionValue(fallbackValue) != null)
              return "layout-override";
            if (Number.isFinite(measurementValue))
              return "measured";
            return "default";
          }
          function shouldLogLayoutDiagnostics(options2 = {}) {
            if (options2.force === true)
              return true;
            if (IS_TEST_ENV)
              return false;
            const target = typeof window2 !== "undefined" ? window2 : globalThis2;
          ...
          function buildLayoutDiagnosticsContext(options2 = {}) {
            var _a3, _b2, _c2, _d2, _e, _f, _g, _h, _i;
            const host = options2.hostElement || getDisplayTileHostElement();
            const hostRect = safeGetElementRect(host);
            const percentCollector = options2.percentCollector || null;
            const perBreakpoint = {};
            const baseSources = {};
            if (options2.baseDimensions) {
              for (const key of BREAKPOINTS) {
                const dims = options2.baseDimensions[key] || {};
                perBreakpoint[key] = {
                  width: Number(dims.width) || null,
                  height: Number(dims.height) || null
                };
                baseSources[key] = ((_a3 = options2.baseSourceMap) == null ? void 0 : _a3[key]) || {
                  width: "unknown",
                  height: "unknown"
                };
              }
            }
            const rowCounts = options2.rowCounts || {};
            const context = {
              ...
              measurement: {
                raw: options2.measurement || null,
                sanitized: {
                  width: (_b2 = options2.measuredWidth) != null ? _b2 : null,
                  height: (_c2 = options2.measuredHeight) != null ? _c2 : null
                },
                strategy: ((_d2 = options2.measurement) == null ? void 0 : _d2.strategy) || null,
                widthSource: ((_e = options2.measurement) == null ? void 0 : _e.widthSource) || null,
                heightSource: ((_f = options2.measurement) == null ? void 0 : _f.heightSource) || null,
                candidates: Array.isArray((_g = options2.measurement) == null ? void 0 : _g.candidates) ? options2.measurement.candidates.map((entry) => ({
                  role: entry.role,
              ...
              base: {
                width: (_h = options2.baseWidth) != null ? _h : null,
                height: (_i = options2.baseHeight) != null ? _i : null,
                perBreakpoint,
                sources: baseSources,
                activeBreakpoint: options2.activeBreakpoint || getActiveBreakpoint()
              },
              trackUnit: options2.trackUnit || layoutState.trackUnit,
              trackUnitSource: options2.trackUnitSource || "state",
              gaps: options2.gaps || {},
              columns: {
                raw: options2.columnsRaw || {},
                applied: options2.columnsApplied || {}
              },
              rows: {
                raw: options2.rowsRaw || {},
                applied: options2.rowsApplied || {},
                counts: rowCounts
              },
          ...
          function logLayoutDiagnostics(context, options2 = {}) {
            var _a3, _b2;
            ...
            if (!shouldLogLayoutDiagnostics(options2)) {
              return payload;
            }
            const logger = typeof console !== "undefined" ? console : null;
            if (!logger)
              return payload;
            const groupFn = typeof logger.groupCollapsed === "function" ? logger.groupCollapsed.bind(logger) : logger.group ? logger.group.bind(logger) : null;
            ...
            logFn("Host size:", `${(_a3 = payload.host.width) != null ? _a3 : "n/a"} \xD7 ${(_b2 = payload.host.height) != null ? _b2 : "n/a"}`);
          ...
          function applyLayoutOverrides(metadata) {
            var _a3, _b2, _c2, _d2;
            const root = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-root");
            const dash = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash");
            if (!root || !dash) {
              layoutState.pendingApply = true;
              return;
            }
            ...
            const hasRowConfig = (value) => Array.isArray(value) || Array.isArray(value == null ? void 0 : value.rows);
            ...
            for (const key of BREAKPOINTS) {
              const value = overrideLayout && hasOwn(overrideLayout, key) ? overrideLayout[key] : void 0;
            ...
            const trackUnitToken = (_d2 = (_c2 = (_b2 = (_a3 = overrideLayout == null ? void 0 : overrideLayout.trackUnit) != null ? _a3 : overrideLayout == null ? void 0 : overrideLayout.unit) != null ? _b2 : overrideLayout == null ? void 0 : overrideLayout.units) != null ? _c2 : overrideLayout == null ? void 0 : overrideLayout.dimensionUnit) != null ? _d2 : null;
            ...
            const desktopColumnsRaw = sanitizeColumns(desktopSection == null ? void 0 : desktopSection.columns, DEFAULT_COLUMNS.desktop, trackUnit);
            const tabletColumnsRaw = sanitizeColumns(
              tabletSection == null ? void 0 : tabletSection.columns,
            ...
            const mobileColumnsRaw = sanitizeColumns(
              mobileSection == null ? void 0 : mobileSection.columns,
              hasMobileOverride ? tabletColumnsRaw : hasTabletOverride || hasDesktopOverride ? tabletColumnsRaw : DEFAULT_COLUMNS.mobile,
              trackUnit
            );
            const desktopGap = sanitizeGap(desktopSection == null ? void 0 : desktopSection.gap, DEFAULT_GAPS.desktop);
            const tabletGap = sanitizeGap(
              tabletSection == null ? void 0 : tabletSection.gap,
              hasTabletOverride ? desktopGap : hasDesktopOverride ? desktopGap : DEFAULT_GAPS.tablet
            );
            const mobileGap = sanitizeGap(
              mobileSection == null ? void 0 : mobileSection.gap,
              hasMobileOverride ? tabletGap : hasTabletOverride || hasDesktopOverride ? tabletGap : DEFAULT_GAPS.mobile
            );
            const gaps = {
              desktop: desktopGap,
              tablet: tabletGap,
            ...
            const fallbackWidth = sanitizeDimension(overrideLayout == null ? void 0 : overrideLayout.baseWidth, measuredWidth);
            const fallbackHeight = sanitizeDimension(overrideLayout == null ? void 0 : overrideLayout.baseHeight, measuredHeight);
            const desktopWidth = sanitizeDimension(desktopSection == null ? void 0 : desktopSection.baseWidth, fallbackWidth);
            const desktopHeight = sanitizeDimension(desktopSection == null ? void 0 : desktopSection.baseHeight, fallbackHeight);
            const tabletWidth = sanitizeDimension(tabletSection == null ? void 0 : tabletSection.baseWidth, desktopWidth);
            const tabletHeight = sanitizeDimension(tabletSection == null ? void 0 : tabletSection.baseHeight, desktopHeight);
            const mobileWidth = sanitizeDimension(mobileSection == null ? void 0 : mobileSection.baseWidth, tabletWidth);
            const mobileHeight = sanitizeDimension(mobileSection == null ? void 0 : mobileSection.baseHeight, tabletHeight);
            ...
            const desktopBaseSource = {
              width: determineDimensionSource({
                sectionValue: desktopSection == null ? void 0 : desktopSection.baseWidth,
                fallbackValue: overrideLayout == null ? void 0 : overrideLayout.baseWidth,
                measurementValue: measurement.width
              }),
              height: determineDimensionSource({
                sectionValue: desktopSection == null ? void 0 : desktopSection.baseHeight,
                fallbackValue: overrideLayout == null ? void 0 : overrideLayout.baseHeight,
                measurementValue: measurement.height
              })
            };
            const tabletBaseSource = {
              width: parseDimensionValue(tabletSection == null ? void 0 : tabletSection.baseWidth) != null ? "section-override" : `inherit-${desktopBaseSource.width}`,
              height: parseDimensionValue(tabletSection == null ? void 0 : tabletSection.baseHeight) != null ? "section-override" : `inherit-${desktopBaseSource.height}`
            };
            const mobileBaseSource = {
              width: parseDimensionValue(mobileSection == null ? void 0 : mobileSection.baseWidth) != null ? "section-override" : `inherit-${tabletBaseSource.width}`,
              height: parseDimensionValue(mobileSection == null ? void 0 : mobileSection.baseHeight) != null ? "section-override" : `inherit-${tabletBaseSource.height}`
            };
            const baseSourceMap = {
            ...
            if (trackUnit === "percent") {
              ...
              if (adjustedDesktopColumns)
                desktopColumns = adjustedDesktopColumns;
              ...
              if (adjustedTabletColumns)
                tabletColumns = adjustedTabletColumns;
              ...
              if (adjustedMobileColumns)
                mobileColumns = adjustedMobileColumns;
              ...
              if (adjustedDesktopRows)
                desktopRows = adjustedDesktopRows;
              ...
              if (adjustedTabletRows)
                tabletRows = adjustedTabletRows;
              ...
              if (adjustedMobileRows)
                mobileRows = adjustedMobileRows;
            }
            const columns = {
            ...
            if (!changed && !layoutState.pendingApply)
              return;
            ...
            const hasLightningArea = templateHasArea(finalTemplates.desktop, "lightning") || templateHasArea(finalTemplates.tablet, "lightning") || templateHasArea(finalTemplates.mobile, "lightning");
            if (hasLightningArea) {
          ...
          function setupScaling(displayTile, content) {
            ...
            if (!scaleResizeHandler) {
              ...
              window2.addEventListener("resize", scaleResizeHandler);
            }
            ...
            scaleObserver = new ResizeObserver(() => {
              ...
              if (measurement.changed) {
                layoutState.pendingApply = true;
                applyLayoutOverrides(lastSuccessfulPayload == null ? void 0 : lastSuccessfulPayload.metadata);
              }
              applyScale(root);
            });
          ...
          function setupBreakpointListeners() {
            if (breakpointListenersRegistered)
              return;
            if (typeof window2 === "undefined" || typeof window2.matchMedia !== "function")
              return;
          ...
          function normalizeDimensionEntry(entry, fallback) {
            const fallbackWidth = Number(fallback == null ? void 0 : fallback.width) || DEFAULT_BASE_WIDTH;
            const fallbackHeight = Number(fallback == null ? void 0 : fallback.height) || DEFAULT_BASE_HEIGHT;
            return {
              width: Number(entry == null ? void 0 : entry.width) || fallbackWidth,
              height: Number(entry == null ? void 0 : entry.height) || fallbackHeight
            };
          }
          function getActiveBreakpoint() {
            const grid = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-grid");
            if (grid && typeof window2 !== "undefined" && typeof window2.getComputedStyle === "function") {
              try {
                const computed = window2.getComputedStyle(grid);
                ...
                if (normalized && normalized !== "none") {
                  ...
                  const matches = [];
                  if (normalized === lookup.mobile)
                    matches.push("mobile");
                  if (normalized === lookup.tablet)
                    matches.push("tablet");
                  if (normalized === lookup.desktop)
                    matches.push("desktop");
                  if (matches.length === 1) {
                    return matches[0];
                  }
                }
            ...
            if (window2.matchMedia("(max-width: 720px)").matches) {
              return "mobile";
            }
            if (window2.matchMedia("(max-width: 1100px)").matches) {
              return "tablet";
            }
            return "desktop";
          }
          ...
          function applyScale(rootEl) {
            const root = rootEl || document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-root");
            if (!root)
              return;
            ...
            const baseWidth = Math.max(1, Number(activeBase == null ? void 0 : activeBase.width) || Number(currentBaseWidth) || DEFAULT_BASE_WIDTH);
            const baseHeight = Math.max(1, Number(activeBase == null ? void 0 : activeBase.height) || Number(currentBaseHeight) || DEFAULT_BASE_HEIGHT);
          ...
          function mergePayloads(payloads) {
            ...
            for (const segment of payloads) {
              ...
              if (Array.isArray(segment.ambientSensors)) {
                ...
                if (Number.isFinite(total))
                  ambientMeta.total = total;
                if (segment.ambientRotationSeconds != null)
                  ambientMeta.rotation = segment.ambientRotationSeconds;
                if (segment.ambientHumidityUnit != null)
              ...
              for (const [key, value] of Object.entries(segment)) {
                if (key === "ambientSensors" || key === "totalAmbientSensors" || key === "ambientRotationSeconds" || key === "ambientHumidityUnit" || key === "segmentIndex" || key === "segmentSize") {
                  continue;
                }
            ...
            if (ambientSensors.length) {
              ambientSensors.sort((a, b) => {
                const aOrdinal = Number(a == null ? void 0 : a.ordinal);
                const bOrdinal = Number(b == null ? void 0 : b.ordinal);
          ...
          function resolveAmbientSensors(data) {
            const sensors = Array.isArray(data == null ? void 0 : data.ambientSensors) ? data.ambientSensors.filter(Boolean) : [];
            if (sensors.length)
              return sensors;
            const indoor = data == null ? void 0 : data.indoor;
          ...
          function resolveAmbientSeedState(data) {
            ...
            if (!sensors.length)
              return null;
            const normalizedSensors = sensors.map((sensor, index2) => ({ sensor, index: index2 }));
            const desiredKeys = [];
            const previousSensor = Array.isArray(ambientRotation.sensors) ? ambientRotation.sensors[ambientRotation.index] || null : null;
            if (previousSensor) {
              const prevKey = getAmbientSensorKey(previousSensor, ambientRotation.index);
              if (prevKey)
                desiredKeys.push(prevKey);
              if (previousSensor.name != null) {
                const prevNameKey = getAmbientNameKey(previousSensor.name);
                if (prevNameKey)
                  desiredKeys.push(prevNameKey);
              }
            }
            ...
            if (index < 0)
              index = 0;
            if (index >= normalizedSensors.length)
              index = normalizedSensors.length - 1;
            ...
            let humidity = Number.isFinite((_a3 = active.sensor) == null ? void 0 : _a3.humidity) ? active.sensor.humidity : null;
            if (!Number.isFinite(humidity)) {
              const cached = lookupAmbientCachedHumidity(active.sensor, sensorKey, (_b2 = active.sensor) == null ? void 0 : _b2.name);
          ...
          function buildCardMarkupList(data, options2) {
          ...
          function createElementFromMarkup(markup) {
            if (typeof markup !== "string" || !markup.trim().length)
              return null;
            const template = document2.createElement("div");
          ...
          function buildTempWindCard(data) {
            ...
            const trendSuffix = `\xB0${getDisplayTemperatureUnit()}/hr`;
            ...
            const indicatorLabel = indicatorLabelUnit ? `Switch temperature display to ${indicatorLabelUnit}` : "Switch temperature display";
            const generatedAt = (_a3 = data.metadata) == null ? void 0 : _a3.generatedAt;
            const stationReportedAt = ((_b2 = data.metadata) == null ? void 0 : _b2.weatherStationTime) || generatedAt;
    ...
    `;
            ...
            const windIndicatorLabel = windIndicatorLabelUnit ? `Switch wind display to ${windIndicatorLabelUnit}` : "Switch wind display";
    ...
    `;
          ...
          function initAmbientLastHum(container) {
            ...
            try {
              ...
              const headerName = ((_a3 = scope.querySelector(".wdash-ambient-name")) == null ? void 0 : _a3.textContent) || "";
              const headerKey = getAmbientNameKey(headerName);
              let last = null;
          ...
          function buildAmbientSensorCard(data, seedOptions) {
            ...
            const nameDisplay = hasSensors ? sensorName.length ? sensorName : "Ambient Sensor" : "Ambient Sensors";
            const rotationText = hasSensors ? sensors.length > 1 ? `Sensor ${index + 1} of ${sensors.length}` : "" : "No sensors configured";
            const tempDisplay = formatTemperature(tempPair.f);
            const humiditySource = Number.isFinite(sensor.humidity) ? sensor.humidity : seed && Number.isFinite(seed.humidity) ? seed.humidity : null;
            ...
            const humidityOffset = humidityValue != null ? Math.round(humidityCircumference - humidityValue / 100 * humidityCircumference) : humidityCircumference;
            const humidityDataAttr = humidityValue != null ? ` data-last-hum="${humidityValue}"` : ' data-last-hum=""';
    ...
    `;
          ...
          function buildLightningCard(data) {
            ...
            const zone = (() => {
              var _a4;
              const raw = (_a4 = data == null ? void 0 : data.metadata) == null ? void 0 : _a4.weatherStationTimezone;
              if (!raw)
                return null;
            ...
            const distanceMiles = toNumber((_a3 = lightning.distanceMi) != null ? _a3 : lightning.distance);
            ...
            const batteryIcon = renderBatteryIcon({
              ...
              orientation: "landscape",
              showLabel: false,
              title: Number.isFinite(battery) ? `Lightning sensor battery ${Math.round(clamp(battery, 0, 100))}%` : "Lightning sensor battery level unavailable"
            });
            ...
            const indicatorLabel = nextUnitLabel ? `Switch lightning distance display to ${nextUnitLabel}` : "Switch lightning distance display";
    ...
    `;
          ...
          function buildRainCard(data) {
            ...
            const dailyDepthHtml = dailyDepth.isValid ? `<span class="wdash-rain-daily-value-amount">${escapeHtml(dailyDepth.valueText)}</span><span class="wdash-rain-daily-value-unit">${escapeHtml(dailyDepth.unitText)}</span>` : `<span class="wdash-rain-daily-value-amount">--</span>`;
            return `
    ...
    `;
          ...
          function buildPressureOutlookBadge(outlook) {
            const iconKey = typeof (outlook == null ? void 0 : outlook.iconKey) === "string" ? outlook.iconKey.trim().toLowerCase() : "";
            const iconLabel = (() => {
              const raw = (outlook == null ? void 0 : outlook.iconLabel) || (outlook == null ? void 0 : outlook.category) || (outlook == null ? void 0 : outlook.label);
              if (raw == null)
                return "";
            ...
            const summary = (() => {
              const raw = (outlook == null ? void 0 : outlook.summary) || (outlook == null ? void 0 : outlook.text);
              if (raw == null)
                return "";
              const str = typeof raw === "string" ? raw : String(raw);
              return str.trim();
      ...
      `;
          ...
          function resolveSolarSunViewModel(data) {
            var _a3, _b2, _c2;
            const solar = (data == null ? void 0 : data.solar) || {};
            ...
            const now = parseDateTime((_a3 = data == null ? void 0 : data.metadata) == null ? void 0 : _a3.generatedAt);
            ...
            const moonAriaParts = [];
            if (moonPhaseName && moonPhaseName !== "Unknown")
              moonAriaParts.push(moonPhaseName);
            if (Number.isFinite(illuminationPercent)) {
            ...
            const stationReportedAt = ((_b2 = data == null ? void 0 : data.metadata) == null ? void 0 : _b2.weatherStationTime) || ((_c2 = data == null ? void 0 : data.metadata) == null ? void 0 : _c2.generatedAt);
            const stationLabel = stationReportedAt ? formatHubDateTime(stationReportedAt) : null;
            const stationZoneLabel = (() => {
              var _a4;
              const zone = (_a4 = data == null ? void 0 : data.metadata) == null ? void 0 : _a4.weatherStationTimezone;
              if (!zone)
                return "";
          ...
          function resolveSunMarkerState(view) {
            ...
            const formatCoord = (value, fallback) => {
              ...
              return String(Math.round(chosen * 1e3) / 1e3);
            };
    ...
    `.trim();
          ...
          function createSunMarkerElement(state) {
            ...
            const glow = document2.createElementNS(NS, "circle");
            ...
            const core = document2.createElementNS(NS, "circle");
          ...
          function buildSolarSunCard(data) {
            ...
            const solarValueHtml = view.showSolarMetric ? `${escapeHtml(view.solarDisplay)} <span class="wdash-sun-metric-unit">${escapeHtml(view.solarUnit)}</span>` : "";
            return `
    ...
    `;
          ...
          function resolveAirQualitySources(data) {
            const sources = [];
            if (hasAirQualityData(data == null ? void 0 : data.outdoorAirQuality, "Outdoor"))
              sources.push("Outdoor");
            if (hasAirQualityData(data == null ? void 0 : data.indoorAirQuality, "Indoor"))
              sources.push("Indoor");
            return sources;
          }
          ...
          function buildAirQualityCard(data) {
            ...
            const currentSource = availableSources.includes(rotationSource) ? rotationSource : availableSources[0] || "";
            const airData = currentSource === "Indoor" ? data == null ? void 0 : data.indoorAirQuality : currentSource === "Outdoor" ? data == null ? void 0 : data.outdoorAirQuality : null;
            const metricsBySource = {};
            for (const source of availableSources) {
              const sourceData = source === "Indoor" ? data == null ? void 0 : data.indoorAirQuality : data == null ? void 0 : data.outdoorAirQuality;
            ...
            if (!availableSources.length) {
              ...
              const baseMetrics = metricsBySource[currentSource] || buildAirQualityMetrics(airData, currentSource);
              const spansAllColumns = airQualitySpansAllColumns();
              const normalizedMetrics = spansAllColumns ? harmonizeAirQualityMetrics(baseMetrics, metricsBySource) : baseMetrics;
            ...
            const batterySlot = currentSource ? buildBatterySlot(toNumber(airData == null ? void 0 : airData.battery), {
              orientation: "landscape",
              className: "wdash-air-battery",
              label: batteryLabel,
              titlePrefix: `${batteryLabel} battery`
            }) : "";
            const headerSourceMarkup = currentSource ? `<span class="wdash-air-source">${escapeHtml(currentSource)}</span>` : "";
            const headerHtml = `
    ...
    `;
          ...
          function buildAirQualityMetrics(air, type) {
            ...
            if (Number.isFinite(pm25)) {
              pushMetric("pm25", "PM2.5", `${formatNumber(pm25, 1)} \xB5g/m\xB3`);
            }
            if (Number.isFinite(pm25_24h)) {
              pushMetric("pm25_24h", "PM2.5 24h AVE", `${formatNumber(pm25_24h, 1)} \xB5g/m\xB3`);
            }
            if (type === "Indoor") {
              ...
              if (Number.isFinite(pm10)) {
                pushMetric("pm10", "PM10", `${formatNumber(pm10, 1)} \xB5g/m\xB3`);
              }
              if (Number.isFinite(pm10_24h)) {
                pushMetric("pm10_24h", "PM10 24h AVE", `${formatNumber(pm10_24h, 1)} \xB5g/m\xB3`);
              }
          ...
          function padAirQualityMetrics(metrics, options2 = {}) {
            const list = Array.isArray(metrics) ? metrics.slice() : [];
            const columns = Number.isFinite(options2.columns) ? Math.max(1, Number(options2.columns)) : 4;
            const maxRows = Number.isFinite(options2.maxRows) ? Math.max(1, Number(options2.maxRows)) : 2;
          ...
          function alignAirMetricsToOrder(metrics, keyOrder) {
            ...
            if (!keys.length)
              return list.slice();
            const metricByKey = /* @__PURE__ */ new Map();
            for (const metric of list) {
              const key = getAirMetricKey(metric);
              if (!key || metricByKey.has(key))
                continue;
          ...
          function getAirMetricKey(metric) {
            ...
            if (typeof metric.label === "string" && metric.label.trim()) {
              const normalized = metric.label.trim().toLowerCase().replace(/[^a-z0-9]+/gi, "-").replace(/^-+|-+$/g, "");
          ...
          function determineAirMetricGrid(metrics) {
            ...
            for (let columns = maxColumns; columns >= 1; columns -= 1) {
              ...
              if (placeholders < bestPlaceholders || placeholders === bestPlaceholders && rows < bestRows || placeholders === bestPlaceholders && rows === bestRows && columns > bestColumns) {
                bestColumns = columns;
                bestRows = rows;
          ...
          function airQualitySpansAllColumns() {
            const templates = (layoutState == null ? void 0 : layoutState.templates) || DEFAULT_TEMPLATES;
            const breakpoints = ["desktop", "tablet", "mobile"];
            for (const key of breakpoints) {
              const template = (templates == null ? void 0 : templates[key]) || DEFAULT_TEMPLATES[key];
          ...
          function templateHasFullRowOfArea(compiledTemplate, areaName) {
            ...
            if (!normalizedArea)
              return false;
            const lines = compiledTemplate.areas.split(/\n+/).map((line) => line.replace(/["']/g, " ").trim()).filter(Boolean);
            for (const line of lines) {
              const tokens = line.split(/\s+/).map((token) => normalizeAreaToken(token)).filter(Boolean);
              if (!tokens.length)
                continue;
          ...
          function syncTemperatureUnitIndicators() {
            const buttons = document2.querySelectorAll("#" + DISPLAY_TILE_ID + ' [data-temp-unit-indicator="true"]');
            if (!buttons.length)
              return;
          ...
          function syncWindUnitIndicators() {
            const buttons = document2.querySelectorAll("#" + DISPLAY_TILE_ID + ' [data-wind-unit-indicator="true"]');
            if (!buttons.length)
              return;
          ...
          function syncPressureUnitIndicators() {
            const buttons = document2.querySelectorAll("#" + DISPLAY_TILE_ID + ' [data-pressure-unit-indicator="true"]');
            if (!buttons.length)
              return;
          ...
          function syncRainUnitIndicators() {
            const buttons = document2.querySelectorAll("#" + DISPLAY_TILE_ID + ' [data-rain-unit-indicator="true"]');
            if (!buttons.length)
              return;
          ...
          function syncLightningUnitIndicators() {
            const buttons = document2.querySelectorAll("#" + DISPLAY_TILE_ID + ' [data-lightning-unit-indicator="true"]');
            if (!buttons.length)
              return;
          ...
          function applyTemperatureUnitsFromMetadata(metadata) {
            ...
            const inputCandidate = (_c2 = (_b2 = (_a3 = unitsSource == null ? void 0 : unitsSource.input) != null ? _a3 : unitsSource == null ? void 0 : unitsSource.source) != null ? _b2 : unitsSource == null ? void 0 : unitsSource.sensor) != null ? _c2 : metadata.temperatureInputUnit;
            const displayCandidate = (_f = (_e = (_d2 = unitsSource == null ? void 0 : unitsSource.display) != null ? _d2 : unitsSource == null ? void 0 : unitsSource.default) != null ? _e : unitsSource == null ? void 0 : unitsSource.output) != null ? _f : metadata.temperatureDisplayUnit;
          ...
          function applyRainUnitsFromMetadata(metadata) {
            ...
            const inputCandidate = (_c2 = (_b2 = (_a3 = unitsSource == null ? void 0 : unitsSource.input) != null ? _a3 : unitsSource == null ? void 0 : unitsSource.source) != null ? _b2 : unitsSource == null ? void 0 : unitsSource.sensor) != null ? _c2 : metadata.rainInputUnit;
            const displayCandidate = (_f = (_e = (_d2 = unitsSource == null ? void 0 : unitsSource.display) != null ? _d2 : unitsSource == null ? void 0 : unitsSource.default) != null ? _e : unitsSource == null ? void 0 : unitsSource.output) != null ? _f : metadata.rainDisplayUnit;
          ...
          function applyWindUnitsFromMetadata(metadata) {
            ...
            const inputCandidate = (_c2 = (_b2 = (_a3 = unitsSource == null ? void 0 : unitsSource.input) != null ? _a3 : unitsSource == null ? void 0 : unitsSource.source) != null ? _b2 : unitsSource == null ? void 0 : unitsSource.sensor) != null ? _c2 : metadata.windInputUnit;
            const displayCandidate = (_f = (_e = (_d2 = unitsSource == null ? void 0 : unitsSource.display) != null ? _d2 : unitsSource == null ? void 0 : unitsSource.default) != null ? _e : unitsSource == null ? void 0 : unitsSource.output) != null ? _f : metadata.windDisplayUnit;
          ...
          function applyPressureUnitsFromMetadata(metadata) {
            ...
            const inputCandidate = (_c2 = (_b2 = (_a3 = unitsSource == null ? void 0 : unitsSource.input) != null ? _a3 : unitsSource == null ? void 0 : unitsSource.source) != null ? _b2 : unitsSource == null ? void 0 : unitsSource.sensor) != null ? _c2 : metadata.pressureInputUnit;
            const displayCandidate = (_f = (_e = (_d2 = unitsSource == null ? void 0 : unitsSource.display) != null ? _d2 : unitsSource == null ? void 0 : unitsSource.default) != null ? _e : unitsSource == null ? void 0 : unitsSource.output) != null ? _f : metadata.pressureDisplayUnit;
          ...
          function applyLightningUnitsFromMetadata(metadata) {
            ...
            const inputCandidate = (_c2 = (_b2 = (_a3 = unitsSource == null ? void 0 : unitsSource.input) != null ? _a3 : unitsSource == null ? void 0 : unitsSource.source) != null ? _b2 : unitsSource == null ? void 0 : unitsSource.sensor) != null ? _c2 : metadata.lightningInputUnit;
            const displayCandidate = (_f = (_e = (_d2 = unitsSource == null ? void 0 : unitsSource.display) != null ? _d2 : unitsSource == null ? void 0 : unitsSource.default) != null ? _e : unitsSource == null ? void 0 : unitsSource.output) != null ? _f : metadata.lightningDisplayUnit;
          ...
          function setTemperatureDisplayUnit(unit) {
            ...
            if (normalized === temperatureUnitState.display) {
              const metadataDefault2 = temperatureUnitState.metadataDisplay;
              temperatureUnitState.displayOverride = metadataDefault2 ? normalized !== metadataDefault2 : temperatureUnitState.displayOverride;
              refreshTemperatureUnitUI();
              return;
            }
          ...
          function setRainDisplayUnit(unit) {
            ...
            if (normalized === rainUnitState.display) {
              const metadataDefault2 = rainUnitState.metadataDisplay;
              rainUnitState.displayOverride = metadataDefault2 ? normalized !== metadataDefault2 : rainUnitState.displayOverride;
              refreshRainUnitUI();
              return;
            }
          ...
          function setWindDisplayUnit(unit) {
            ...
            if (normalized === windUnitState.display) {
              const metadataDefault2 = windUnitState.metadataDisplay;
              windUnitState.displayOverride = metadataDefault2 ? normalized !== metadataDefault2 : windUnitState.displayOverride;
              refreshWindUnitUI();
              return;
            }
          ...
          function setPressureDisplayUnit(unit) {
            ...
            if (normalized === pressureUnitState.display) {
              const metadataDefault2 = pressureUnitState.metadataDisplay;
              pressureUnitState.displayOverride = metadataDefault2 ? normalized !== metadataDefault2 : pressureUnitState.displayOverride;
              refreshPressureUnitUI();
              return;
            }
          ...
          function setLightningDisplayUnit(unit) {
            ...
            if (normalized === lightningUnitState.display) {
              const metadataDefault2 = lightningUnitState.metadataDisplay;
              lightningUnitState.displayOverride = metadataDefault2 ? normalized !== metadataDefault2 : lightningUnitState.displayOverride;
              refreshLightningUnitUI();
              return;
            }
          ...
          function formatTemperatureUnitIndicator(unit) {
            const normalized = normalizeTemperatureUnit(unit);
            return normalized ? `\xB0${normalized}` : "";
          }
          ...
          function normalizeWindUnit(value) {
            ...
            if (!normalized)
              return null;
            if (normalized === "mph" || normalized === "mi" || normalized === "mile" || normalized === "miles")
              return "mph";
            if (normalized === "kph" || normalized === "kmh" || normalized === "km" || normalized === "kilometer" || normalized === "kilometers")
              return "kph";
            if (normalized === "kts" || normalized === "kt" || normalized === "knot" || normalized === "knots")
              return "kts";
            return null;
          }
          ...
          function normalizePressureUnit(value) {
            ...
            if (!normalized)
              return null;
            if (normalized === "inhg" || normalized === "mmhg")
              return "inhg";
            if (normalized === "mb" || normalized === "kpa")
              return "mb";
          ...
          function normalizePressureUnitForConversion(value) {
            ...
            if (!normalized)
              return null;
            if (normalized === "inhg" || normalized === "in" || normalized === "hg" || normalized === "inch" || normalized === "inches")
              return "inhg";
            if (normalized === "mb" || normalized === "mbar" || normalized === "millibar" || normalized === "millibars" || normalized === "hpa" || normalized === "hectopascal" || normalized === "hectopascals")
              return "mb";
            if (normalized === "kpa" || normalized === "kilopascal" || normalized === "kilopascals")
              return "kpa";
            if (normalized === "mmhg" || normalized === "mm")
              return "mmhg";
            return null;
          }
          ...
          function readStoredTemperatureUnit(type) {
            ...
            if (!key)
              return null;
            try {
              if (typeof window2 === "undefined" || !window2.localStorage)
                return null;
            } catch (e) {
              return null;
            }
            try {
              const stored = window2.localStorage.getItem(key);
          ...
          function persistTemperatureUnit(type, unit) {
            ...
            try {
              window2.localStorage.setItem(key, normalized);
            } catch (err) {
            }
          }
          ...
          function resolveTemperaturePair(valueF, valueC) {
            if (arguments.length <= 1 || valueC === void 0) {
          ...
          function setupHubClock(data) {
            var _a3, _b2, _c2;
            const target = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-updated [data-hub-clock]");
            if (!target) {
              stopHubClock();
              return;
            }
            ...
            const zone = (() => {
              var _a4;
              const raw = ((_a4 = data == null ? void 0 : data.metadata) == null ? void 0 : _a4.weatherStationTimezone) || dataset.hubClockZone;
              if (!raw)
                return null;
              const text = String(raw).trim();
              return text.length ? text : null;
            })();
            const timezoneEl = ((_a3 = target.parentElement) == null ? void 0 : _a3.querySelector("[data-hub-clock-timezone]")) || null;
            const zoneLabel = (() => {
              if (zone)
                return zone;
              if (timezoneEl && timezoneEl.textContent)
                return timezoneEl.textContent.trim();
              return "";
            })();
            if (timezoneEl) {
              timezoneEl.textContent = zoneLabel;
            }
            const isoSource = ((_b2 = data == null ? void 0 : data.metadata) == null ? void 0 : _b2.weatherStationTime) || ((_c2 = data == null ? void 0 : data.metadata) == null ? void 0 : _c2.generatedAt) || dataset.hubClockSource || null;
            if (!isoSource) {
              target.textContent = "";
              stopHubClock();
              return;
            ...
            renderHubClock(true);
            hubClockState.timer = setInterval(renderHubClock, 1e3);
          }
          ...
          function renderHubClock(force = false) {
            ...
            if (hasSegmentTargets) {
              ...
              if (force || assembled !== hubClockState.lastText) {
                ...
                if (timeEl)
                  timeEl.textContent = segments.time;
                if (meridiemEl)
                  meridiemEl.textContent = segments.meridiem;
                hubClockState.lastText = assembled;
              }
              return;
            }
            const text = hubClockState.mode === "clock" ? formatHubClock(parts) : formatHubDateTime(parts);
          ...
          function computeHubClockParts() {
            ...
            const offsetMs = Number.isFinite(offsetMinutes) ? offsetMinutes * 6e4 : 0;
          ...
          function hubClockPartsToUtc(parts) {
            ...
            return baseUtc - offsetMinutes * 6e4;
          }
          function computeTimeZoneOffsetMinutes(utcMs, zone) {
            if (!Number.isFinite(utcMs) || !zone)
              return null;
            ...
            try {
              ...
              if (!Number.isFinite(components.year) || !Number.isFinite(components.month) || !Number.isFinite(components.day)) {
                return null;
              }
              ...
              if (!Number.isFinite(localizedUtc))
                return null;
              const rawDiffMinutes = (localizedUtc - utcMs) / 6e4;
              if (!Number.isFinite(rawDiffMinutes))
                return null;
          ...
          function applyAmbientRingSizing() {
            const container = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-ambient");
            if (!container)
              return;
          ...
          function applyOutdoorRingSizing() {
            const container = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-temp");
            if (!container)
              return;
            const gaugeSvg = container.querySelector(".wdash-gauge-svg");
            if (gaugeSvg)
              applyRingSizing(gaugeSvg, OUTDOOR_RING);
            const windContainer = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-wind");
            if (windContainer) {
          ...
          function teardownTempWindGaugeSizing() {
            ...
            if (tempWindGaugeResizeHandler) {
              window2.removeEventListener("resize", tempWindGaugeResizeHandler);
              tempWindGaugeResizeHandler = null;
            }
            if (tempWindGaugeHosts.length) {
              tempWindGaugeHosts.forEach((host) => {
                var _a3;
                const gauge = (_a3 = host == null ? void 0 : host.querySelector) == null ? void 0 : _a3.call(host, ".wdash-gauge, .wdash-wind-compass");
                if (gauge == null ? void 0 : gauge.style) {
          ...
          function setupTempWindGaugeSizing(container) {
            ...
            const hostsChanged = hosts.length !== tempWindGaugeHosts.length || hosts.some((host, index) => tempWindGaugeHosts[index] !== host);
            if (hostsChanged) {
              teardownTempWindGaugeSizing();
            ...
            if (typeof ResizeObserver === "function") {
              ...
              window2.addEventListener("resize", tempWindGaugeResizeHandler);
            }
          }
          function applyTempWindGaugeSize(host) {
            ...
            if (!gauge)
              return;
            const measured = typeof host.getBoundingClientRect === "function" ? host.getBoundingClientRect() : null;
            const width = (_b2 = (_a3 = measured == null ? void 0 : measured.width) != null ? _a3 : host.clientWidth) != null ? _b2 : 0;
            const height = (_d2 = (_c2 = measured == null ? void 0 : measured.height) != null ? _c2 : host.clientHeight) != null ? _d2 : 0;
          ...
          function updateTempWindCard() {
            var _a3, _b2;
            const card = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-card--temp-wind");
            if (!card)
              return;
            const data = tempWindState.data;
            const outdoor = (data == null ? void 0 : data.outdoor) || {};
            const wind = (data == null ? void 0 : data.wind) || {};
            const avg = wind.average || {};
            const tempPair = resolveTemperaturePair(outdoor.temperature);
            const highPair = resolveTemperaturePair(outdoor.dailyHigh);
            const lowPair = resolveTemperaturePair(outdoor.dailyLow);
            ...
            const dailyMaxGust = toNumber(wind.dailyMaxGustMph);
            const bearingLabel = dirText || (Number.isFinite(dirDegrees) ? degreesToCardinal(dirDegrees) : "--");
            const headingText = Number.isFinite(dirDegrees) ? formatDegrees(dirDegrees) : "--\xB0";
            const displayWindUnit = getDisplayWindUnit();
            const windUnitLabel = formatWindUnitLabel(displayWindUnit);
            const speedDisplay = convertWindSpeed(speed, "mph", displayWindUnit);
            const gustDisplay = convertWindSpeed(gust, "mph", displayWindUnit);
            ...
            if (gauge && gauge.style) {
              ...
              if (Array.isArray(tempColor.colors)) {
                if (tempColor.colors[0])
                  gauge.style.setProperty("--gauge-color-a", tempColor.colors[0]);
                if (tempColor.colors[1])
                  gauge.style.setProperty("--gauge-color-b", tempColor.colors[1]);
              }
              if (tempColor.mid)
                gauge.style.setProperty("--gauge-color-mid", tempColor.mid);
            ...
            if (gaugeValueEl)
              gaugeValueEl.textContent = formatTemperature(tempF);
            ...
            if (indicatorButton) {
              ...
              if (indicatorButton.textContent !== indicatorText)
                indicatorButton.textContent = indicatorText;
            ...
            const detailValues = [
              ...
              formatSigned(convertTemperatureDelta(trendPair.f, "F", getDisplayTemperatureUnit()), 1, `\xB0${getDisplayTemperatureUnit()}/hr`),
              avgCombinedText,
              dailyMaxGustText
            ];
            ...
            const generatedAt = (_a3 = data == null ? void 0 : data.metadata) == null ? void 0 : _a3.generatedAt;
            const stationReportedAt = ((_b2 = data == null ? void 0 : data.metadata) == null ? void 0 : _b2.weatherStationTime) || generatedAt;
            const stationLabel = stationReportedAt ? formatHubClock(stationReportedAt, { includeSeconds: false }) : null;
            const updatedLabel = stationLabel ? `Updated ${stationLabel}` : "";
            ...
            const ariaHeading = headingText || "--\xB0";
            if (compass) {
            ...
            if (headingEl) {
              const text = headingText ? ` ${headingText}` : " --\xB0";
              if (headingEl.textContent !== text)
            ...
            if (windIndicatorButton) {
              ...
              if (windIndicatorButton.textContent !== indicatorText)
                windIndicatorButton.textContent = indicatorText;
              if (label) {
            ...
            if (compass) {
              ...
              if (avgArrow && avgArrow.style) {
                ...
                if (existingAvg && existingAvg.style)
                  existingAvg.style.display = "none";
              }
            }
          ...
          function updateSolarSunCard() {
            const card = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-card--solar");
            if (!card || !solarState.data)
              return;
          ...
          function setupPressureToggle(container) {
            ...
            buttons.forEach((button) => {
              if (button.dataset.pressureListenerBound === "true")
                return;
          ...
          function ensureAmbientCountdownTimer() {
            if (ambientRotation.countdownTimer)
              return;
          ...
          function updateAmbientTimerDisplay() {
            const button = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-ambient-timer");
            if (!button)
              return;
            ...
            const label = ambientRotation.sensors.length > 1 ? ambientRotation.paused ? "Resume ambient sensor rotation" : "Pause ambient sensor rotation" : "Ambient sensor rotation unavailable";
            button.setAttribute("aria-label", label);
            button.setAttribute("title", label);
            ...
            if (countdownEl) {
              if (disabled) {
                ...
                const remaining = Math.max(0, Math.ceil(remainingMs / 1e3));
                countdownEl.textContent = String(remaining);
              }
            }
          }
          function updateAmbientNextButton() {
            const button = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-ambient-next");
            if (!button)
              return;
            const disabled = ambientRotation.sensors.length <= 1;
            if (button.disabled !== disabled) {
            ...
            const label = ambientRotation.sensors.length > 1 ? "Show next ambient sensor" : "Ambient sensor rotation unavailable";
            button.setAttribute("aria-label", label);
            button.setAttribute("title", label);
          }
          function resolveAmbientRotationIntervalMs(data) {
            const rawSeconds = data == null ? void 0 : data.ambientRotationSeconds;
            if (rawSeconds == null)
              return DEFAULT_AMBIENT_ROTATION_INTERVAL_MS;
          ...
          function setupAmbientRotation(data) {
            ...
            ambientRotation.tempUnit = `\xB0${getDisplayTemperatureUnit()}`;
            ambientRotation.humidityUnit = (data == null ? void 0 : data.ambientHumidityUnit) || "%";
          ...
          function updateAmbientDisplay() {
            ...
            if (!sensor) {
              if (tempEl)
                tempEl.textContent = formatTemperature(null);
              if (humidityEl)
                humidityEl.textContent = formatAmbientValue(null, ambientRotation.humidityUnit, 0);
              if (nameEl)
                nameEl.textContent = "No sensors configured";
              if (rotationEl)
                rotationEl.textContent = "";
              container.classList.add("wdash-ambient--empty");
              if (card)
                card.classList.add("wdash-ambient--empty");
              if (batteryEl) {
            ...
            if (card)
              card.classList.remove("wdash-ambient--empty");
            const sensorName = sensor && typeof sensor.name === "string" ? sensor.name.trim() : "";
            const tempPair = resolveTemperaturePair(sensor.temperature);
            if (tempEl)
              tempEl.textContent = formatTemperature(tempPair.f);
            if (humidityEl)
              humidityEl.textContent = formatAmbientValue(sensor.humidity, ambientRotation.humidityUnit, 0);
            if (nameEl)
              nameEl.textContent = sensorName.length ? sensorName : "Ambient Sensor";
            if (rotationEl) {
              rotationEl.textContent = ambientRotation.sensors.length > 1 ? `Sensor ${ambientRotation.index + 1} of ${ambientRotation.sensors.length}` : "";
            }
            if (batteryEl) {
            ...
            try {
              ...
              if (tempFill && tempTrack) {
                ...
                if (svg) {
                  ...
                  if (grad) {
                    ...
                    if (stops[0])
                      stops[0].setAttribute("stop-color", tempColors.colors[0]);
                    if (stops[1])
                      stops[1].setAttribute("stop-color", tempColors.mid);
                    if (stops[2])
                      stops[2].setAttribute("stop-color", tempColors.colors[1]);
                  } else {
              ...
              if (humFill && humTrack) {
                ...
                if (!Number.isFinite(prevHum)) {
                  const headerName = (((_a3 = scope.querySelector(".wdash-ambient-name")) == null ? void 0 : _a3.textContent) || "").trim();
                ...
                if (String(humFill.getAttribute("stroke-dashoffset")) !== String(offset)) {
                  ...
                  if (typeof requestAnimationFrame === "function") {
                    requestAnimationFrame(() => {
                      try {
                        humFill.setAttribute("stroke-dashoffset", String(offset));
                      } catch (e) {
                      }
                    });
                  } else {
                ...
                try {
                  const headerName = (((_b2 = scope.querySelector(".wdash-ambient-name")) == null ? void 0 : _b2.textContent) || "").trim();
                  const headerKey = getAmbientNameKey(headerName);
                  const sensorNameKey = sensor && sensor.name != null ? getAmbientNameKey(sensor.name) : null;
                  if (sensorKey)
                    ambientLastHumidity.set(sensorKey, hum);
                  if (sensorNameKey)
                    ambientLastHumidity.set(sensorNameKey, hum);
                  if (headerKey)
                    ambientLastHumidity.set(headerKey, hum);
                  if (humFill.dataset) {
                    humFill.dataset.lastHum = String(hum);
                    if (sensorKey)
                      humFill.dataset.sensorKey = sensorKey;
                  }
          ...
          function updateAirQualityCard() {
            const card = document2.querySelector("#" + DISPLAY_TILE_ID + " .wdash-card--air");
            if (!card || !airQualityRotation.lastData)
              return;
            const newMarkup = buildAirQualityCard(airQualityRotation.lastData);
            card.outerHTML = newMarkup;
          }
          function cardHeader(title, data, subLabel = null, options2 = {}) {
            var _a3, _b2, _c2;
            const {
            ...
            if (clock && clock !== false) {
              ...
              if (mode)
                spanAttributes.push(`data-hub-clock-mode="${escapeHtml(mode)}"`);
              if (clock.source)
                spanAttributes.push(`data-hub-clock-source="${escapeHtml(clock.source)}"`);
            ...
            if (clock && clock !== false) {
              ...
              if (clock.source)
                candidateSources.push(clock.source);
              if ((_b2 = data == null ? void 0 : data.metadata) == null ? void 0 : _b2.weatherStationTime)
                candidateSources.push(data.metadata.weatherStationTime);
              if ((_c2 = data == null ? void 0 : data.metadata) == null ? void 0 : _c2.generatedAt)
                candidateSources.push(data.metadata.generatedAt);
      ...
      `;
            ...
            const leadingHtml = leadingMarkup.length > 0 ? `<span class="wdash-card-header-leading">${leadingMarkup}</span>` : "";
            const subtitleHtml = subtitleText ? `<span class="wdash-card-subtitle">${escapeHtml(subtitleText)}</span>` : "";
            return `
      <header class="${headerClasses}">
        ${leadingHtml}
        <div class="wdash-card-header-main">
    ...
    `;
          ...
          function windCompassSvg(directionDegrees, averageDegrees) {
            ...
            const labelRadius = innerR + (r - innerR) * 0.5;
            ...
            function solveDelta(innerR2, outerR) {
              const toRad = (deg) => deg * Math.PI / 180;
              const f = (deg) => {
                const a = toRad(deg);
                const B = 2 * outerR * Math.sin(a);
                const s = Math.sqrt(innerR2 * innerR2 + outerR * outerR - 2 * innerR2 * outerR * Math.cos(a));
                return B - s / 2;
              };
              let lo = 1;
              let hi = 60;
  ...
  ${avg === null ? "" : `<g class="wdash-compass-arrow wdash-compass-arrow--avg" style="transform: rotate(${avg}deg);"><path d="${avgPath}" class="wdash-compass-avg" fill="none" stroke="rgba(208,213,220,0.95)" stroke-width="1.0" stroke-linejoin="round" /></g>`}
    ...
    `;
          ...
          function buildMetricRow(items, extraClass = "", options2 = {}) {
            if (!Array.isArray(items) || !items.length)
              return "";
            const { variant, columns, layout } = options2 || {};
      ...
      <div class="${className}"${styleAttr}>
        ${items.map((item) => {
              ...
              const tintColor = !isPlaceholder ? sanitizeHexColor(item == null ? void 0 : item.color) : null;
              const useDarkText = tintColor ? shouldUseDarkTextForTint(tintColor) : false;
              const metricClasses = ["wdash-metric"];
              if (tintColor)
                metricClasses.push("wdash-metric--tinted");
              if (useDarkText)
                metricClasses.push("wdash-metric--tinted-light");
              if (isPlaceholder)
                metricClasses.push("wdash-metric--placeholder");
              ...
              const labelText = isPlaceholder ? "" : escapeHtml((item == null ? void 0 : item.label) || "");
              const valueText = isPlaceholder ? "" : (item == null ? void 0 : item.value) != null ? escapeHtml(item.value) : "--";
              const subText = !isPlaceholder && (item == null ? void 0 : item.sub) != null ? escapeHtml(item.sub) : null;
              return `
    ...
    `;
          ...
          function parseHexColorToRgb(hex) {
            ...
            if (!/^#([0-9a-f]{3}|[0-9a-f]{4}|[0-9a-f]{6}|[0-9a-f]{8})$/.test(normalized))
              return null;
          ...
          function compileLayoutTemplates(layoutConfig, options2 = {}) {
            var _a3;
            const breakpoints = ["desktop", "tablet", "mobile"];
            const trackUnit = normalizeTrackUnit((_a3 = options2.trackUnit) != null ? _a3 : layoutConfig == null ? void 0 : layoutConfig.trackUnit);
            const result = {};
            for (const key of breakpoints) {
              const section = layoutConfig && layoutConfig[key];
              const rows = Array.isArray(section) ? section : Array.isArray(section == null ? void 0 : section.rows) ? section.rows : [];
              result[key] = compileGridTemplate(rows, trackUnit);
            }
            return result;
          }
          function applyLayoutStyle(config) {
            if (!config || typeof document2 === "undefined")
              return;
            const styleText = buildLayoutStyleText(config);
            if (!styleText)
              return;
            let styleEl = document2.getElementById(LAYOUT_STYLE_ID);
            if (!styleEl) {
              styleEl = document2.createElement("style");
          ...
          function templateHasArea(compiledTemplate, areaName) {
            ...
            const tokens = compiledTemplate.areas.replace(/["']/g, " ").split(/\s+/).filter(Boolean);
          ...
          function normalizeAreaToken(value) {
            ...
            if (typeof value !== "string")
              return null;
            let token = value.trim().replace(/[\u2018\u2019\u201a\u201b\u2032\u2035]/g, "'").replace(/[\u201c\u201d\u201e\u201f\u2033\u2036]/g, '"');
            if (!token)
              return null;
            if (token === ".")
              return ".";
          ...
          function compileGridTemplate(layout, trackUnit = DEFAULT_TRACK_UNIT) {
            ...
            for (const entry of layout) {
              const repeat = Math.max(1, Number(entry == null ? void 0 : entry.repeat) || 1);
              const columns = Array.isArray(entry == null ? void 0 : entry.columns) ? entry.columns.map(normalizeAreaToken).filter((col) => typeof col === "string" && col.length) : [];
              if (!columns.length)
                continue;
              const track = normalizeTrackSize((_b2 = (_a3 = entry == null ? void 0 : entry.height) != null ? _a3 : entry == null ? void 0 : entry.rowHeight) != null ? _b2 : entry == null ? void 0 : entry.size, trackUnit);
            ...
            const rowsValue = hasCustomTrack ? rowTracks.join(" ") : `repeat(${safeRowCount}, ${defaultTrack})`;
          ...
          function normalizeTrackSize(value, trackUnit = DEFAULT_TRACK_UNIT) {
            ...
            if (typeof value === "string") {
              ...
              if (!trimmed)
                return defaultTrack;
              if (/^var\(\s*--[\w-]+\s*(?:,[^)]*)?\)$/i.test(trimmed))
                return trimmed;
              if (/^(?:calc|minmax|clamp|fit-content)\((?:[^()]+|\([^()]*\))*\)$/i.test(trimmed))
                return trimmed;
          ...
          function sanitizeColumns(value, fallback, trackUnit = DEFAULT_TRACK_UNIT) {
            if (Array.isArray(value)) {
              const tracks = value.map((item) => normalizeTrackSize(item, trackUnit)).filter(Boolean);
              if (tracks.length) {
                return tracks.join(" ");
              }
            }
          ...
          function adjustPercentRowTracks(rowsValue, rowCount, baseHeight, gapValue, frameGapValue, options2 = {}) {
            ...
            if (options2 && options2.collector && typeof options2.collector.recordRow === "function") {
              options2.collector.recordRow({
                breakpoint: options2.breakpoint || "desktop",
                raw: rowsValue,
          ...
          function adjustPercentColumnTracks(columnsValue, baseWidth, gapValue, frameGapValue, options2 = {}) {
            if (typeof columnsValue !== "string" || !columnsValue.trim())
              return null;
            ...
            if (columnGap == null || horizontalPadding == null)
              return null;
            const totalPercent = percents.reduce((sum, value) => sum + value, 0);
            if (!Number.isFinite(totalPercent) || totalPercent <= 0)
              return null;
            ...
            const distribution = resolvePercentPixelDistribution(percents, totalPercent, available);
            const pixelValues = distribution.values;
            if (options2 && options2.collector && typeof options2.collector.recordColumn === "function") {
              options2.collector.recordColumn({
                breakpoint: options2.breakpoint || "desktop",
                raw: columnsValue,
                percents: percents.slice(),
                pixels: pixelValues.slice(),
          ...
          function extractPercentTracks(value) {
            ...
            if (percents.some((value2) => value2 == null))
              return null;
            return percents;
          }
          ...
          function injectCSS() {
            if (document2.getElementById(CSS_ID))
              return;
...
@media (max-width: 720px) {
  ...
  .wdash { --wdash-frame-gap: var(--wdash-frame-gap-mobile, var(--wdash-frame-gap-tablet, var(--wdash-frame-gap-desktop, 18px))); }
    ...
    `;
          ...
          function colorForTemp(temp) {
            ...
            for (const entry of TEMP_COLORS) {
              ...
              if (temp <= bandMax) {
                const span2 = maxValue - previousMax || 1;
                const local2 = clamp((temp - previousMax) / span2, 0, 1);
                const gradientPosition2 = 0.2 + local2 * 0.6;
                return {
                  colors: entry.colors,
                  mid: mixColors(entry.colors[0], entry.colors[1], local2),
                  progress: gradientPosition2
                };
              }
              previousMax = bandMax;
            }
          ...
          function normalizeMoonPhaseKey(moon) {
            ...
            if (typeof moon.phase === "string" && moon.phase.trim().length) {
              ...
              if (MOON_PHASE_NAME_MAP[normalized])
                return MOON_PHASE_NAME_MAP[normalized];
          ...
          function formatTemperature(value, options2 = {}) {
            const decimalsInput = Number(options2.decimals);
            const decimals = Number.isFinite(decimalsInput) ? decimalsInput : 1;
            const includeUnit = options2.includeUnit === true;
            const sourceUnit = normalizeTemperatureUnit(options2.sourceUnit) || "F";
            const targetUnit = normalizeTemperatureUnit(options2.unit) || getDisplayTemperatureUnit();
            const numeric = toNumber(value);
            if (!Number.isFinite(numeric)) {
              return includeUnit ? `--\xB0${targetUnit}` : "--\xB0";
            }
            const converted = convertTemperatureValue(numeric, sourceUnit, targetUnit);
            if (!Number.isFinite(converted)) {
              return includeUnit ? `--\xB0${targetUnit}` : "--\xB0";
            }
            const suffix = includeUnit ? `\xB0${targetUnit}` : "\xB0";
          ...
          function formatRainParts(value, options2 = {}) {
            const perHour = options2.perHour === true;
            const decimalsInput = Number(options2.decimals);
            const decimals = Number.isFinite(decimalsInput) ? decimalsInput : 2;
            const sourceUnit = normalizeRainUnit(options2.sourceUnit) || "in";
            const targetUnit = normalizeRainUnit(options2.unit) || getDisplayRainUnit();
            const numeric = toNumber(value);
            if (!Number.isFinite(numeric)) {
          ...
          function formatRain(value, options2 = {}) {
            const parts = formatRainParts(value, options2);
            if (!parts.isValid)
              return "--";
            const unitText = parts.perHour ? `${parts.unitText}/hr` : parts.unitText;
            return `${parts.valueText} ${unitText}`;
          }
          function formatLightningDistance(value, options2 = {}) {
            const decimalsInput = Number(options2.decimals);
            const decimals = Number.isFinite(decimalsInput) ? decimalsInput : 1;
            const sourceUnit = normalizeLightningUnit(options2.sourceUnit) || "mi";
            const targetUnit = normalizeLightningUnit(options2.unit) || getDisplayLightningUnit();
            const numeric = toNumber(value);
            if (!Number.isFinite(numeric))
              return "--";
          ...
          function formatPressure(value, options2 = {}) {
            const sourceUnit = normalizePressureUnitForConversion(options2.sourceUnit) || "inhg";
            const targetUnit = normalizePressureUnit(options2.displayUnit) || getDisplayPressureUnit();
            const numeric = toNumber(value);
            if (!Number.isFinite(numeric))
              return "--";
          ...
          function formatPressureChange(value, options2 = {}) {
            const sourceUnit = normalizePressureUnitForConversion(options2.sourceUnit) || "inhg";
            const targetUnit = normalizePressureUnit(options2.displayUnit) || getDisplayPressureUnit();
            const perHour = options2.perHour === true;
            const numeric = toNumber(value);
          ...
          function formatDegrees(value) {
            if (!Number.isFinite(value))
              return "--\xB0";
            return `${value.toFixed(0)}\xB0`;
          }
          function buildBatterySlot(levelInput, options2 = {}) {
            const orientation = String(options2.orientation || "").toLowerCase() === "landscape" ? "landscape" : "portrait";
            const showLabel = !!options2.showLabel;
            const hideWhenInvalid = options2.hideWhenInvalid !== false;
            const rawLabel = options2.label != null ? String(options2.label) : "";
            const label = rawLabel.trim();
            const titlePrefix = options2.titlePrefix != null ? String(options2.titlePrefix).trim() : label ? `${label} battery` : "";
            const className = options2.className ? ` ${options2.className}` : "";
            const ariaHidden = options2.ariaHidden ? ' aria-hidden="true"' : "";
            const level = Number.isFinite(levelInput) ? clamp(levelInput, 0, 100) : null;
            const iconTitle = level != null && titlePrefix ? `${titlePrefix} ${Math.round(level)}%` : titlePrefix && level == null ? `${titlePrefix}` : "";
            const iconHtml = level != null ? renderBatteryIcon({
              level,
              orientation,
              showLabel,
              title: iconTitle
            ...
            if (label)
              dataset.push(`data-battery-label="${escapeHtml(label)}"`);
            if (titlePrefix)
              dataset.push(`data-battery-title-prefix="${escapeHtml(titlePrefix)}"`);
            return `
      <div class="${classes}" ${dataset.join(" ")}${ariaHidden}>${iconHtml}</div>
    `;
          }
          function updateBatterySlot(element, levelInput, options2 = {}) {
            if (!element)
              return;
            const orientation = options2.orientation ? String(options2.orientation).toLowerCase() === "landscape" ? "landscape" : "portrait" : element.dataset.batteryOrientation === "landscape" ? "landscape" : "portrait";
            const showLabel = options2.showLabel != null ? !!options2.showLabel : element.dataset.batteryShowLabel === "true";
            const hideWhenInvalid = options2.hideWhenInvalid != null ? !!options2.hideWhenInvalid : element.dataset.batteryHideWhenInvalid !== "false";
            const rawLabel = options2.label != null ? String(options2.label) : element.dataset.batteryLabel || "";
            const label = rawLabel.trim();
            const titlePrefix = options2.titlePrefix != null ? String(options2.titlePrefix).trim() : element.dataset.batteryTitlePrefix || (label ? `${label} battery` : "");
            const level = Number.isFinite(levelInput) ? clamp(levelInput, 0, 100) : null;
            ...
            const title = titlePrefix ? level != null ? `${titlePrefix} ${Math.round(level)}%` : titlePrefix : "";
            const iconHtml = level != null ? renderBatteryIcon({
              level,
              orientation,
              showLabel,
          ...
          function renderBatteryIcon(options2 = {}) {
            const hasLevel = Object.prototype.hasOwnProperty.call(options2 || {}, "level");
            const rawLevel = hasLevel ? options2.level : null;
            let level = Number.isFinite(rawLevel) ? Number(rawLevel) : toNumber(rawLevel);
            level = Number.isFinite(level) ? clamp(level, 0, 100) : null;
            const orientation = options2 && String(options2.orientation).toLowerCase() === "landscape" ? "landscape" : "portrait";
            const showLabel = !!(options2 && options2.showLabel);
            ...
            const indices = orientation === "portrait" ? Array.from({ length: segmentCount }, (_, idx) => segmentCount - 1 - idx) : Array.from({ length: segmentCount }, (_, idx) => idx);
            ...
            const title = options2 && options2.title ? String(options2.title) : "";
    ...
    `;
          ...
          function formatRelativeTime(value) {
            ...
            if (Math.abs(diff) < 60 * 1e3)
              return "just now";
            const minutes = Math.round(Math.abs(diff) / 6e4);
            if (minutes < 60)
          ...
          function convertLocalPartsToUtc(parts, zone) {
            ...
            if (!Number.isFinite(baseLocal))
              return NaN;
            if (Number.isFinite(parts.offsetMinutes)) {
              return baseLocal - Number(parts.offsetMinutes) * 6e4;
            }
            if (!zone) {
              return baseLocal;
            }
          ...
          function calculateDaysAgo(nowUtc, eventUtc) {
            if (!Number.isFinite(nowUtc) || !Number.isFinite(eventUtc))
              return null;
          ...
          function parseIsoDateParts(value) {
            ...
            if (strictMatch) {
              const year2 = Number(strictMatch[1]);
              const month2 = Number(strictMatch[2]);
              const day2 = Number(strictMatch[3]);
              const hasTime2 = strictMatch[4] != null;
              const hour2 = hasTime2 ? Number(strictMatch[4]) : null;
              const minute2 = hasTime2 ? Number(strictMatch[5]) : null;
              const second2 = hasTime2 && strictMatch[6] != null ? Number(strictMatch[6]) : 0;
              let offsetMinutes = null;
              const tzRaw = hasTime2 ? strictMatch[7] : null;
              if (tzRaw) {
                if (tzRaw === "Z") {
                  offsetMinutes = 0;
                } else {
          ...
          function clockSegmentsFromParts(parts, options2 = {}) {
            if (!parts || !parts.hasTime)
              return null;
            ...
            const includeSeconds = options2 && options2.includeSeconds !== false;
            const time = includeSeconds ? `${hourStr}:${minuteStr}:${secondStr}` : `${hourStr}:${minuteStr}`;
            return { time, meridiem, text: `${time} ${meridiem}` };
          }
          function formatHubClock(value, options2) {
            const parts = value && typeof value === "object" && "hour" in value ? value : parseIsoDateParts(value);
            if (!parts || !parts.hasTime) {
              return value != null ? String(value) : "";
            }
            const segments = clockSegmentsFromParts(parts, options2);
            if (!segments) {
          ...
          function formatHubDateTime(value) {
            const parts = value && typeof value === "object" && ("year" in value || "month" in value || "day" in value) ? value : parseIsoDateParts(value);
            if (!parts) {
              return value != null ? String(value) : "";
            }
            const dateText = formatHubDateFromParts(parts);
          ...
          if (!IS_TEST_ENV && typeof window2 !== "undefined") {
            window2.weatherDashboard = window2.weatherDashboard || {};
            window2.weatherDashboard.__renderer__ = api;
            window2.weatherDashboard.logLayoutDiagnostics = () => logLayoutDiagnostics(null, { force: true });
            window2.weatherDashboard.captureLayoutDiagnostics = () => layoutState.lastDiagnostics;
          }
          if (IS_TEST_ENV) {
            const target = typeof window2 !== "undefined" ? window2 : globalThis2;
            ...
            Object.assign(target.__WDASH_TEST_HOOKS__, {
              ...
              getAirQualityRotationState: () => ({
                ...
                sources: Array.isArray(airQualityRotation.sources) ? airQualityRotation.sources.slice() : [],
  ...
  // src/entries/hubitat-dashboard.js
  var require_hubitat_dashboard = __commonJS({
    "src/entries/hubitat-dashboard.js"(exports, module) {
      var { createLegacyWeatherDashboardRenderer } = require_render();
      (function bootstrapWeatherDashboard(global) {
        ...
        const resolveFactoryFromModule = () => {
          ...
          if (typeof __require !== "function")
            return null;
          try {
            const mod = require_render();
            return mod && typeof mod.createLegacyWeatherDashboardRenderer === "function" ? mod.createLegacyWeatherDashboardRenderer : null;
          } catch (err) {
            return null;
          }
        };
        const factory = global.weatherDashboard && global.weatherDashboard.__rendererFactory || global.createLegacyWeatherDashboardRenderer || resolveFactoryFromModule();
