...
const bannerComment = () => '/*! Hubitat Weather Dashboard bundle - generated by ecowitt-weather-hubitat-dashboard build */';

const hubitatValuePrelude = () => `if (typeof window !== "undefined") {
  ...
  try {
    ...
    try {
      ...
      // ignored – Hubitat inline scripts will still observe window.value
    }
  }
}`;
