    ...
    dynamicPage(name: "landingPage") {
        section("Dashboard preview") {
            ...
            if (embedUrl) {
                ...
                paragraph "<iframe src=\"${encodedSrc}\" style=\"width: 100%; max-width: 1260px; height: 840px; border: 0; display: block; margin: 0 auto;\" sandbox=\"allow-same-origin allow-scripts allow-forms allow-popups\"></iframe>"
