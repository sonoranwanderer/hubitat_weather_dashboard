...
function patchDashboardGlitches(global) {
  ...
  const ensureValueArray = () => {
    ...
    try {
      ...
      // ignore assignment failures; Hubitat scripts may still create the array
    }
  };
  ...
  const installNoopHistory = () => {
    ...
    const descriptor = {
      ...
      set(next) {
        ...
        setTimeout(installNoopHistory, 0);
      }
    };
  ...
  if (typeof global.addEventListener === 'function' && !global.__wdashSocketGuard) {
