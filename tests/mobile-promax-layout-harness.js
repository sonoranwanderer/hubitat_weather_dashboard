...
function assertMobileCssScoped(document) {
  ...
  assert(mobileCss.includes('.wdash-rain-main { grid-template-columns: minmax(0, 0.65fr) minmax(0, 0.95fr) minmax(0, 1.25fr); gap: 9px; min-height: 0; position: relative; padding-inline: 0; }'), 'mobile rain card should anchor floating elements inside the rain grid');
