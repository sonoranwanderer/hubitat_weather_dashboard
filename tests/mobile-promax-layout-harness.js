...
function assertMobileCssScoped(document) {
  ...
  assert(mobileCss.includes('.wdash-rain-main { grid-template-columns: minmax(0, 0.65fr) minmax(0, 0.95fr) minmax(0, 1.25fr); gap: 9px; width: 100%; min-height: 0; margin-inline: 0; position: relative; }'), 'mobile rain card should use its full compact width and anchor floating elements inside the rain grid');
